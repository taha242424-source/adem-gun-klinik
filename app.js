...
function initInteractiveImplantStage() {
  const stageData = [
    ...
    {
      stepTitle: 'AŞAMA 02 / ANALİZ',
      telemetry: 'ÇÖZÜNÜRLÜK: 0.1mm DİJİTAL CT',
      imgSrc: 'assets/stage2_3d_scan.jpg',
      imgAlt: 'Aşama 02: 3D Tomografi & Kemik Haritası',
      material: 'Düşük Doz 3D Volumetrik Tarama',
      goal: 'Kılavuz Cerrahi Açı Belirleme',
    },
    {
      stepTitle: 'AŞAMA 03 / CERRAHİ',
      telemetry: 'TORK: 45 Ncm | GRADE-5 TİTANYUM',
      imgSrc: 'assets/stage3_titanium_implant.jpg',
      imgAlt: 'Aşama 03: Titanyum İmplant & Osseointegrasyon',
      material: 'Medikal Titanyum Mikro-Yiv Vida',
      goal: 'Biyolojik Osseointegrasyon',
    },
    {
      stepTitle: 'AŞAMA 04 / RESTORASYON',
      telemetry: 'IŞIK GEÇİRGENLİK: %45 TRANSLUSENT',
      imgSrc: 'assets/stage4_zirconia_crown.jpg',
      imgAlt: 'Aşama 04: Zirkonyum Abutment & Kuron Montajı',
      material: 'CAD/CAM Zirkonyum Monolitik Blok',
      goal: 'Doğal Diş Estetiği & Renk Uyumu',
    },
    {
      stepTitle: 'AŞAMA 05 / SONUÇ',
      telemetry: 'ÇİĞNEME KUVVETİ: 800 N/cm²',
      imgSrc: 'assets/stage5_perfect_smile.jpg',
      imgAlt: 'Aşama 05: Kusursuz Gülüş & Fonksiyon',
